...
public class TeamBuildingController {
	...
	public void postTeamParticipateApply(@PathVariable @Positive Long teamId, @Positive Long userId) {
		teamBuildingService.teamParticipate(teamId, userId, String.valueOf(APPLIED));
	}
	...
	public void postSuggestionByTeam(@PathVariable @Positive Long teamId, @PathVariable @Positive Long userId) {
		teamBuildingService.teamParticipate(teamId, userId, String.valueOf(SUGGESTED));
	}
	...
	public void deleteTeamParticipateApply(@PathVariable @Positive Long teamId, @PathVariable @Positive Long userId) {
		teamBuildingService.refuseOrCancelTeamParticipate(teamId, userId);
	}
	...
	public void postTeamParticipate(@PathVariable @Positive Long teamId, @PathVariable @Positive Long userId) {
		teamBuildingService.acceptTeamParticipate(teamId, userId);
	}
	...
	@GetMapping("/applying")
	@ResponseStatus(OK)
	public TeamApplicationResponseDto getTeamParticipateApplyingList(@Positive Long userId, @RequestParam @Positive Long teamId) {
		return teamBuildingService.getTeamParticipateList(userId, teamId, APPLIED);
	}

	// 팀 참가 권유받은 팀 목록 조회
	@GetMapping("/suggested")
	@ResponseStatus(OK)
	public TeamApplicationResponseDto getTeamParticipateSuggestionList(@Positive Long userId, @RequestParam @Positive Long teamId) {
		return teamBuildingService.getTeamParticipateList(userId, teamId, SUGGESTED);
	}
