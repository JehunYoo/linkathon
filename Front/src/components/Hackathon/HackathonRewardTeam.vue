...
<template>
  <div class="container">
    ...
    <h1>프로젝트 주제</h1>
    <section>
      프로젝트 설명프로젝트 설명프로젝트 설명프로젝트 설명프로젝트 설명프로젝트 설명프로젝트 설명프로젝트 설명프로젝트프로젝트 설명프로젝트
    </section>
    <h1>팀원 목록</h1>
    <div class="member-img-container">
      <img src="https://blog.kakaocdn.net/dn/dhP2Wq/btrFKnODpIa/3NTHnbvwNK8wUt14uiL2r0/img.jpg" alt=""
           class="member-img" v-for="_ in 6">
    </div>
    <h1>기술 스택</h1>
