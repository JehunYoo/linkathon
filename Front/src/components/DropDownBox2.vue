...
const updateSelect: Function = <Function>inject('selectedMenuGender');
...
const handleClickOutside = (event: MouseEvent) => {
  const dropdownContainer = document.querySelector('.click-out1');
...
<template>
  <div class="dropdown-container click-out1" @click="toggleDropdown">
