...
const dummySkill = Builder<SkillDTO>()
    .skillName("")
...
<template>
  <div class="user-card">
    ...
    <div class="text-container">
      <div class="info-text">
        카리나
        <Tier style="margin-left: 8px" :rating="300" width="28px" height="16px" font-size="14px"></Tier>
      </div>
      <div class="introduce-text">
        안녕하세요. 백엔드 개발자입니다. 동해번쩍 서해번쩍 잘합니다. 동해번쩍 서해번...
      </div>
      <div style="display: flex; gap:4px; flex: 1">
        <SkillIcon width="20px" height="20px" :skill="dummySkill" radius="4px"/>
        <SkillIcon width="20px" height="20px" :skill="dummySkill" radius="4px"/>
      </div>
    </div>
  </div>
